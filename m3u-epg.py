...
def update_m3u():
    ...
    m3u_url = "http://m3u4u.com/m3u/8p4ey8mvw5fq89z8ng1v"  # URL da lista M3U
    output_file = "8p4ey8mvw5fq89z8ng1v.m3u"
    download_file(m3u_url, output_file)

def update_epg():
    """Atualiza o EPG."""
    epg_url = "http://m3u4u.com/epg/8p4ey8mvw5fq89z8ng1v"  # URL do EPG
    output_file = "epg.xml"
