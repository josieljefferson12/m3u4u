...
def update_m3u():
    ...
    m3u_url = "http://m3u4u.com/m3u/d5k2nvdkg9h353qkn984"  # URL da lista M3U
    output_file = "playlist_epg-m3u.m3u"
    download_file(m3u_url, output_file)

def update_epg():
    """Atualiza o EPG."""
    epg_url = "http://m3u4u.com/epg/d5k2nvdkg9h353qkn984"  # URL do EPG
    output_file = "playlist_epg-m3u.xml.gz"
