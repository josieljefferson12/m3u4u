...
def update_m3u():
    ...
    m3u_url = "http://m3u4u.com/m3u/3wk1y24kx7uzdevxygz7"  # URL da lista M3U
    output_file = "m3u4u@proton.me.m3u.m3u"
    download_file(m3u_url, output_file)

def update_epg():
    """Atualiza o EPG."""
    epg_url = "http://m3u4u.com/epg/3wk1y24kx7uzdevxygz7"  # URL do EPG
    output_file = "m3u4u@proton.me.m3u.xml.gz"
